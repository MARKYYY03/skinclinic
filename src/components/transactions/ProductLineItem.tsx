...
export default function ProductLineItem({
  ...
  return (
    <div className="flex items-center gap-3 rounded-lg border border-gray-200 bg-green-50 p-4">
      <div className="flex-1">
        <p className="font-medium text-gray-900">{item.name}</p>
        <p className="text-sm text-gray-600">Product • ₱{item.unitPrice.toLocaleString()}</p>
      </div>
